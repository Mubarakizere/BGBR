        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                ...
                <div class="flex items-center gap-3">
                    {{-- Search Form --}}
                    <form action="{{ route('battalions.index') }}" method="GET" class="relative">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search battalions..." 
                            ...
                            <tr class="hover:bg-primary/[0.02] transition-colors duration-150 group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="group relative inline-block">
                                        ...
                                        <div class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max px-3 py-2 bg-gray-800 text-white text-[11px] font-medium rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 shadow-lg border border-gray-700">
                                            A battalion is active when it has 5 or more companies. <br>
                                            <span class="text-gray-400">Current companies: {{ $battalion->companies_count ?? 0 }}</span>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        <a href="{{ route('battalions.show', $battalion) }}" class="p-2 rounded-lg text-muted hover:text-blue-500 hover:bg-blue-500/10 transition-all" title="View Details">
                                        ...
                                        <button type="button" 
                                            @click="$dispatch('open-delete-modal', { action: '{{ route('battalions.destroy', $battalion) }}', message: 'Are you sure you want to delete this battalion? This action cannot be undone.' })"
