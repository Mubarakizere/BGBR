                            ...
                            <tr class="hover:bg-primary/[0.02] transition-colors duration-150 group">
                                        ...
                                        <div class="flex flex-wrap gap-1.5">
                                            @foreach($company->officers as $officer)
                                                <span class="inline-flex items-center gap-1 pl-1 pr-2 py-0.5 rounded-full text-[11px] font-medium bg-primary/5 border border-primary/10 text-text">
                                                    ...
                                                    <button type="button" @click="$dispatch('open-delete-modal', { action: '{{ route('companies.officers.remove', [$company, $officer]) }}', message: 'Are you sure you want to remove this officer from the company?' })" class="ml-0.5 text-muted hover:text-danger transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        <button type="button" 
                                            @click="$dispatch('open-delete-modal', { action: '{{ route('companies.destroy', $company) }}', message: 'Are you sure you want to delete this company? This action cannot be undone.' })"
