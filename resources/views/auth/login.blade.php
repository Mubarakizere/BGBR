<x-guest-layout>
    ...
    <div class="text-center mb-8">
        <h2 class="text-3xl font-extrabold text-text tracking-tight">Welcome Back</h2>
        <p class="text-sm text-muted mt-2 font-medium">Sign in to your management account</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input id="password" class="pl-11 block w-full border-border focus:border-primary focus:ring-primary rounded-xl shadow-sm text-text sm:text-sm transition-all duration-200 py-3 bg-background focus:bg-surface" type="password" name="password" required autocomplete="current-password" placeholder="••••••••" />
            </div>
