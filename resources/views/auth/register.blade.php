    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-3">
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input id="name" class="pl-11 block w-full border-border focus:border-secondary focus:ring-secondary rounded-xl shadow-sm text-text sm:text-sm transition-all duration-200 py-2.5 bg-background focus:bg-surface" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="John Doe" />
            </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input id="password" class="pl-11 block w-full border-border focus:border-secondary focus:ring-secondary rounded-xl shadow-sm text-text sm:text-sm transition-all duration-200 py-2.5 bg-background focus:bg-surface" type="password" name="password" required autocomplete="new-password" placeholder="••••••••" />
            </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input id="password_confirmation" class="pl-11 block w-full border-border focus:border-secondary focus:ring-secondary rounded-xl shadow-sm text-text sm:text-sm transition-all duration-200 py-2.5 bg-background focus:bg-surface" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••" />
            </div>
            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2 text-danger" />
        </div>

        <div class="mt-3 bg-primary/5 border-l-4 border-primary p-3 rounded-r-xl">
            <div class="flex">
