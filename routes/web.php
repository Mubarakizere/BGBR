...
/*
|--------------------------------------------------------------------------
| Internal System Routes — Subdomain (portal.bgbr.rw)
|--------------------------------------------------------------------------
|
| All internal management routes are served on the system subdomain.
| These require authentication and are completely separate from the
| public website.
|
*/

Route::domain(config('site.system_domain'))->group(function () {
